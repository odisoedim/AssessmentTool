    ...
    <div class="relative h-full">
      <div class="px-16.5 pt-12 pb-11">
        ...
        <onboarding-introduce-welcome2 v-if="pageIndex === 2">
          <ce-p class="my-2"
            >On this page, you will find the assessments available to your
            organisation. They will help you:</ce-p
          >
...
export default defineComponent({
  name: 'AssessmentsIntroductionModal',
  components: {
    CeP,
    CeModal,
    CeButton,
  ...
  setup() {
    ...
    watch(visible, () => !visible.value && finishOnboarding('assessments'))
    const nextPage = () => {
      pageIndex.value++
    }
